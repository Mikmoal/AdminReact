...
const Page = (props) => {
  const { tareas, evidencias, participantes, grabaciones } = props;
  // const dispatch = useDispatch();
  // useEffect(() => {
  //   dispatch(getById(props.match.params.id))
  // }, [dispatch, props.match.params.id])
  // const detalleDeJunta = useSelector((state) => state.detail)
  //  console.log(Array.isArray(detalleDeJunta))
  //  console.log(detalleDeJunta)
