 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  V.push([
    ...
    function (a) {
      ...
      if ((b = a.u))
        (a = L(Q, "us", [])), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1]);
    },
  ]);
  var Ha = /^(\/[a-zA-Z0-9_\-]+)+$/,
    Ia = [/\/amp\//, /\/amp$/, /^\/amp$/],
    ...
    Pa = function (a, b, c, d, e) {
      ...
      b = l;
      c = b.match(Ma);
      ((d = b.match(Na)) && 1 === d.length && Oa.test(b) && c && 1 === c.length) ||
        W("failed sanity: " + a);
      try {
        a = "?";
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length; ) {
            ...
            f =
              ("object" == k && null != q) || "function" == k
                ? "o" + ((Object.prototype.hasOwnProperty.call(q, p) && q[p]) || (q[p] = ++ka))
                : (typeof q).charAt(0) + q;
      ...
      return void 0 !== a
        ...
        ? (a = K.querySelector("script[nonce]"))
          ? ((a = a.nonce || a.getAttribute("nonce") || ""),
            a && a === String(a) && a.match(Ta) ? (Q.nonce = a) : (Q.nonce = null))
          : null
        : null;
    },
    Xa = function (a) {
  ...
  window.gapi.load("", {
    ...
    _c: {
      ...
      jsl: {
        ...
        h: "m;/_/scs/abc-static/_/js/k=gapi.lb.es.3Hvfq-qILUY.O/d=1/rs=AHpOoo8S72uoBH2c-3rWI1ONnjoWzc4NtQ/m=__features__",
